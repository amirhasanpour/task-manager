...
func (c *todoServiceClient) ListTasksByUser(ctx context.Context, in *ListTasksByUserRequest, opts ...grpc.CallOption) (*ListTasksByUserResponse, error) {
	out := new(ListTasksByUserResponse)
	err := c.cc.Invoke(ctx, "/todo.TodoService/ListTasksByUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TodoService_ListTasksByUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListTasksByUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TodoServiceServer).ListTasksByUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/todo.TodoService/ListTasksByUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TodoServiceServer).ListTasksByUser(ctx, req.(*ListTasksByUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
